...
import { runRebucket } from './rebucket/run';
...
type Subcommand = 'dedup' | 'rebucket' | 'prepare' | 'recover' | 'status' | 'sync';

const subcommands: { name: string; value: Subcommand }[] = [
  { name: 'Dedup    — content-hash dedup raw source files',                 value: 'dedup'    },
  { name: 'Rebucket — refile CSV messages into timestamp-day buckets (1-time)', value: 'rebucket' },
