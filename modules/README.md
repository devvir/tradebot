...
| Collect | **Collector** | Collects RT data from Bitmex WS and persists it in MongoDB | **Infra**: [rabbitmq](../../services/rabbitmq/README.md), [mongodb](../../services/mongodb/README.md)<br>**Services**: [broadcast](../../services/broadcast/README.md), [router](../../services/router/README.md) | Done | [README](./collector/README.md) |
