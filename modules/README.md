...
| Collect | **Collector** | Collects RT data from Bitmex WS and routes to Writer exchange | **Infra**: [rabbitmq](../../services/rabbitmq/README.md)<br>**Services**: [broadcast](../../services/broadcast/README.md), [router](../../services/router/README.md) | Done | [README](./collector/README.md) |
