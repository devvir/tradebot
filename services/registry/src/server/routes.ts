...
export const setupRoutes = (app: Application, db: Db): void => {
  ...
  app.post('/symbols', validateBody(RegisterSymbolSchema), async (_req, res) => {
  ...
  app.post('/currencies', validateBody(RegisterCurrencySchema), async (_req, res) => {
